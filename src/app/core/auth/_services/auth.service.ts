...
const API_ME_URL = '/api/v1/me';
const API_PROFILE_URL = '/api/v1/me/grants';

@Injectable()
export class AuthService {
	private AUTH_API_ENDPOINT: string = environment.AUTH_API_ENDPOINT;

	constructor(private http: HttpClient) {}

	getUserGrant(): Observable<AuthUser> {
        return this.http.get<AuthUser>(this.AUTH_API_ENDPOINT + API_ME_URL);
	}

	getUserProfile(): Observable<Profile> {
        return this.http.get<Profile>(this.AUTH_API_ENDPOINT + API_PROFILE_URL);
    }
